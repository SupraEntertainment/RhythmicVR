...
public partial class @XRIDefaultInputActions: IInputActionCollection2, IDisposable
{
    ...
    private List<IXRIBothHandsActions> m_XRIBothHandsActionsCallbackInterfaces = new List<IXRIBothHandsActions>();
    ...
    public struct XRIBothHandsActions
    {
        ...
        public void AddCallbacks(IXRIBothHandsActions instance)
        {
            if (instance == null || m_Wrapper.m_XRIBothHandsActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_XRIBothHandsActionsCallbackInterfaces.Add(instance);
            @Menu.started += instance.OnMenu;
            @Menu.performed += instance.OnMenu;
            @Menu.canceled += instance.OnMenu;
        }

        private void UnregisterCallbacks(IXRIBothHandsActions instance)
        {
            @Menu.started -= instance.OnMenu;
            @Menu.performed -= instance.OnMenu;
            @Menu.canceled -= instance.OnMenu;
        ...
        public void RemoveCallbacks(IXRIBothHandsActions instance)
        {
            if (m_Wrapper.m_XRIBothHandsActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IXRIBothHandsActions instance)
        {
            foreach (var item in m_Wrapper.m_XRIBothHandsActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_XRIBothHandsActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
