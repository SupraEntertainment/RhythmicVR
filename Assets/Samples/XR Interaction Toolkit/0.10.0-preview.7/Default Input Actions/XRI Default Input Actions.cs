...
public class @XRIDefaultInputActions : IInputActionCollection, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""XRI BothHands"",
            ""id"": ""d6b22979-0010-4f2b-8f00-6ee8293ebe00"",
            ""actions"": [
                {
                    ""name"": ""Menu"",
                    ""type"": ""Button"",
                    ""id"": ""09d7d965-ac7f-4c06-8ad6-88d0e84318ac"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""d4964861-7631-47c6-b6e7-92180148c5f3"",
                ...
                {
                    ""name"": """",
                    ""id"": ""6eedca0d-3e52-4c0d-b7df-37f2056e945d"",
    ...
    ""controlSchemes"": [
        ...
        // XRI BothHands
        m_XRIBothHands = asset.FindActionMap("XRI BothHands", throwIfNotFound: true);
        m_XRIBothHands_Menu = m_XRIBothHands.FindAction("Menu", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_XRIBothHands_Menu;
    public struct XRIBothHandsActions
    {
        private @XRIDefaultInputActions m_Wrapper;
        public XRIBothHandsActions(@XRIDefaultInputActions wrapper) { m_Wrapper = wrapper; }
        public InputAction @Menu => m_Wrapper.m_XRIBothHands_Menu;
        ...
        public void SetCallbacks(IXRIBothHandsActions instance)
        {
            ...
            {
                @Menu.started -= m_Wrapper.m_XRIBothHandsActionsCallbackInterface.OnMenu;
                @Menu.performed -= m_Wrapper.m_XRIBothHandsActionsCallbackInterface.OnMenu;
                @Menu.canceled -= m_Wrapper.m_XRIBothHandsActionsCallbackInterface.OnMenu;
            }
